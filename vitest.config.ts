...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'tests/scoped-child-query.test.ts',
      ...
      'tests/bill-payment-op.test.ts',
      'tests/bill-unpay-op.test.ts',
      'tests/bill-entry-point-parity.test.ts',
      ...
      // 2026-09-22 global consistency layer (shared/domain): ownership resolution,
      // canonical entity types, dedup, liabilities vs payments, date status,
      // financial periods, health, payments, counts, formatting, alerts, UX.
      'tests/consistency-layer-ownership.test.ts',
      'tests/consistency-layer-entities.test.ts',
      'tests/consistency-layer-liabilities.test.ts',
      'tests/consistency-layer-dedup.test.ts',
      'tests/consistency-layer-periods.test.ts',
      'tests/consistency-layer-dates.test.ts',
      'tests/consistency-layer-health.test.ts',
      'tests/consistency-layer-payments.test.ts',
      'tests/consistency-layer-counts.test.ts',
      'tests/consistency-layer-format.test.ts',
      'tests/consistency-layer-alerts.test.ts',
      'tests/consistency-layer-ux.test.ts',
      'tests/consistency-layer-wiring.test.ts',
    ],
