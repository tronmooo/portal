...
// Superseded on the date (QA 2026-09-18 F-07, tests/qa-2026-09-18-money.test.ts):
// paying a bill logs the expense on the day it was PAID, so a Sep 18 payment is
// September's spend even when the bill's next occurrence had rolled to October.
// The category rule below stands unchanged.
describe("BUG-11 a loan payment lands in Debt payments, dated to the day it was paid", () => {
  ...
  it("an unlinked '<loan> payment' bill with no category is still a debt payment, dated to the payment day", async () => {
    const bill = {
