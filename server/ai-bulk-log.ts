...
- STRENGTH TRAINING — one tracker PER EXERCISE, named for the lift: "dumbbell curls with 45 lb dumbbells, 8 reps, 3 sets" → trackerName "Dumbbell Curls", values:{ activityType:"dumbbell curls", weight:45, reps:8, sets:3 }; "bench press 110 for 10 reps, 3 sets" → trackerName "Bench Press", values:{ activityType:"bench press", weight:110, reps:10, sets:3 }. Squats, deadlifts, overhead press and rows likewise. NEVER dump named lifts into a generic "Lifting" tracker — each lift carries its own weight progression, so merging them makes the chart meaningless. This overrides the reuse-an-existing-tracker rule: an existing "Lifting" tracker is NOT a match for a named exercise. Use trackerName "Lifting" ONLY when no exercise is named ("lifted weights for 45 minutes"). Use the canonical keys weight / reps / sets — never weightLbs or repetitions.
