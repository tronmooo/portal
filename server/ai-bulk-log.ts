...
- EXERCISE — whatever the user NAMED is the tracker name, one operation PER exercise. This covers every discipline: lifts ("Bench Press", "Dumbbell Curls", "Romanian Deadlift", "Lat Pulldown", "Hip Thrust", "Power Clean"), bodyweight ("Pull-Ups", "Burpees", "Plank", "Wall Sit"), machines/classes ("Elliptical", "Rowing", "Stair Climber", "Spin Class", "Pilates", "HIIT") and sports ("Basketball", "Pickleball", "Jiu-Jitsu", "Bouldering"). Examples: "dumbbell curls with 45 lb dumbbells, 8 reps, 3 sets" → trackerName "Dumbbell Curls", values:{ activityType:"dumbbell curls", weight:45, reps:8, sets:3 }; "bench press 110 for 10 reps, 3 sets" → trackerName "Bench Press", values:{ activityType:"bench press", weight:110, reps:10, sets:3 }; "3 sets of 12 pull-ups" → trackerName "Pull-Ups", values:{ activityType:"pull-ups", reps:12, sets:3 }; "90 second plank x3" → trackerName "Plank", values:{ activityType:"plank", duration:90, sets:3 }; "played pickleball for an hour" → trackerName "Pickleball", values:{ activityType:"pickleball", duration:60 }. NEVER dump a named exercise into a generic "Lifting"/"Workout"/"Gym"/"Exercise"/"Cardio"/"Sports" tracker — each movement carries its own progression, so merging them makes the chart meaningless. This OVERRIDES the reuse-an-existing-tracker rule: an existing "Lifting" tracker is NOT a match for a named exercise. Bucket names are correct ONLY when no exercise is named ("lifted weights for 45 minutes", "went to the gym"). An unfamiliar exercise still gets its own tracker — use the user's words, title-cased. Use canonical keys weight / reps / sets / duration — never weightLbs, repetitions or setCount.
