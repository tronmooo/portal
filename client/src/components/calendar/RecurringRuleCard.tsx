...
export const RULE_ICONS: Record<OccurrenceKind, any> = {
  ...
  document: FileText, event: CalendarDays, custom: CalendarDays, income: Banknote,
};
...
export const RULE_HSL: Record<OccurrenceKind, string> = {
  ...
  maintenance: "199 55% 52%", appointment: "155 45% 46%", reminder: "48 65% 52%",
  task: "210 55% 58%", habit: "170 45% 46%", document: "215 12% 58%", income: "150 55% 42%",
