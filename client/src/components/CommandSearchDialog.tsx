// ─── Command palette body (lazy chunk) ───────────────────────────────────────
// PERF: split out of CommandSearch.tsx so cmdk + the palette UI only load the
// first time the user opens search (⌘K or the header trigger). See
// components/CommandSearch.tsx for the gate that imports this module.
