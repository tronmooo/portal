...
// tables). Shows a transient check on success. Lives here — rather than inside
// chat.tsx — so the extraction review panel can use it without importing the
// page it is rendered by.
