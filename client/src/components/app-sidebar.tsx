...
import { MessageSquare, LayoutDashboard, Link2, Archive, Settings, Calendar, Circle, Target } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Goals",     href: "/goals",     icon: Target,         accent: "35 85% 55%" },
