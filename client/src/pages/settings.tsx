...
export default function SettingsPage() {
  ...
  const memberSince = userAny?.created_at ? new Date(userAny.created_at).toLocaleDateString("en-US", { month: "long", year: "numeric" }) : null;
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {userAny?.app_metadata?.provider && (
                    <Badge variant="outline" className="text-[10px] capitalize">
                      {userAny.app_metadata.provider === "google" ? "Google" : "Email"}
                    </Badge>
                  )}
                </div>
              </div>
