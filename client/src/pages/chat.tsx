...
import { ExtractionConfirmation, type ExtractionConfirmPayload } from "@/components/chat/ExtractionConfirmation";
...
// CopyButton now lives in @/components/ui/copy-button so the extraction review
// panel (its own file) can use it without importing this page.
...
// ExtractionConfirmation moved to @/components/chat/ExtractionConfirmation —
// the review/save panel is now its own component with a two-phase
// (edit → review → save) flow and destination-based validation.
...
interface MessageRowProps {
  ...
  handleConfirmExtraction: (data: ExtractionConfirmPayload) => Promise<boolean>;
...
export default function ChatPage() {
  ...
  const handleConfirmExtraction = useCallback(async (data: ExtractionConfirmPayload): Promise<boolean> => {
    try {
